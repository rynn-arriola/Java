...
public class Polygon9_9 
{
	...
	{
		RegularPolygon myPolygon= new RegularPolygon(6,4);
		RegularPolygon myPolygon2=new RegularPolygon(10, 4, 5.6,7.8);
		
		System.out.println("Polygon1 \n"+"\nPerimeter: " + myPolygon.getPerimeter()
								+"\nArea: "+ myPolygon.getArea());
		
		System.out.println("\n\nPolygon2 \nNumber of Sides: "+myPolygon2.getN()
							+"\nLength of the side: "+myPolygon2.getSide()
							+"\nX: "+myPolygon2.getX()
							+"\nY: "+myPolygon2.getY()
							+"\nPerimeter: " + myPolygon2.getPerimeter()
							+"\nArea: "+ myPolygon2.getArea());
