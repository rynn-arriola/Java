...
public class Arcs_Example extends Application 
{
  ...
  {   
    Arc arc1 = new Arc(); // Create an arc
    arc1.setCenterX(150);
    arc1.setCenterY(100);
    arc1.setRadiusX(80);
    arc1.setRadiusY(80);
    arc1.setStartAngle(30);
    arc1.setLength(35);
    arc1.setFill(Color.RED); // Set fill color
    arc1.setType(ArcType.ROUND); // Set arc type
    
    Arc arc2 = new Arc(150, 100, 80, 80, 30 + 90, 35); //you can input values here for the sizes;
